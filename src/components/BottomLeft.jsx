...
export default function BottomLeft() {
    ...
    return (
        <div className='section-containers md:w-[80svw] w-svw md:h-[75svh] h-svh absolute bottom-0 left-0'>
            ...
            <div className='absolute md:bottom-[11%] md:left-[7%] md:right-auto bottom-[35%] right-[5%] rotate-3'><Polaroid title={'Linda Linda Linda'} long={true} format={'jpg'} /></div>
            <div className='absolute md:-right-[8.5%] md:left-auto md:top-0 md:bottom-auto bottom-[40%] left-[7%] rotate-3'><Polaroid title={'Swing Girls'} long={true} format={'jpg'} /></div>
            <div className='absolute md:top-[18%] md:right-[11%] md:left-auto top-[32%] left-[3%] scale-75'><Polaroid title={'6期生'} long={false} format={'jpg'} /></div>
