    ...
    return (
        <div className="w-[75svw] h-[75svh] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex md:flex-row flex-col md:gap-0 gap-10">
            ...
            <div className="flex-1 relative">
                <div style={{backgroundImage: `url(${base}/images/Laravel-Logo.wine.svg)`}} className="lg:w-70 md:w-56 w-37 aspect-square absolute md:left-5 md:right-auto md:top-30 right-0 bg-cover bg-center"></div>
                <div className="absolute md:bottom-30 md:left-20 rotate-6 bg-light pl-3 pr-3 pt-1 pb-1 rounded-2xl flex gap-2 items-center shadow-sm">
                    <p>SMK Student</p>
