export default function Book({bgColor, title, url}) {
    ...
    return (
        <div style={{backgroundColor: bgColor}} className={`lg:w-37.5 md:w-28.75 w-20 lg:h-56.25 md:h-43 h-30 lg:text-xl md:text-lg text-base flex md:gap-2 gap-1 md:p-2 p-1 text-light rounded-xl shadow-2xl break-all`} onClick={() => window.open(url)}>
