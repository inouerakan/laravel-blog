...
export default function TopRight() {
    ...
    return (
        <div className='section-containers md:w-[80svw] w-svw md:h-[75svh] h-svh absolute top-0 right-0'>
            ...
            <div className='absolute md:top-[12%] md:left-0 top-[30%] left-[5%] rotate-4'><Polaroid title={'欅'} long={true} format={'jpg'} /></div>
            <div className='absolute md:top-[11%] md:left-[33.5%] top-[42%] left-[37%] -rotate-6'><Polaroid title={'Same numbers'} format={'png'} /></div>
            <div className='absolute md:bottom-[10%] md:right-[28%] md:top-auto top-[30%] right-[10%] scale-75'><Polaroid title={'歩道橋'} long={false} format={'jpg'} /></div>
