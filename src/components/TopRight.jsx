...
export default function TopRight() {
    ...
    return (
        <div className='section-containers w-[80svw] h-[75svh] absolute top-0 right-0'>
            ...
            <div className='absolute top-15 left-95 -rotate-6'><Polaroid title={'Same numbers'} format={'png'} /></div>
            <div className='absolute bottom-10 left-115 -rotate-3'><Book bgColor={'#7C5C3A'} title={'Pengenalan'} url={'https://medium.com/@rakanshaka3/proyek-pengenalan-f47b983e5d2b'} /></div>
