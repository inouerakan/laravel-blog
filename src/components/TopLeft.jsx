...
export default function TopLeft() {
    ...
    return (
        <div className='section-containers md:w-[80svw] w-svw md:h-[75svh] h-svh absolute top-0 left-0'>
            ...
            <div className='absolute md:bottom-[4%] md:left-[29%] bottom-[10%] left-[10%] -rotate-4'><Polaroid title={'心に穴が空いた'} long={true} format={'webp'} /></div>
            <div className='absolute md:right-[18%] md:top-[14%] md:left-auto left-[10%] top-[22%] rotate-3'><Polaroid title={'エキセントリック'} long={false} format={'webp'} /></div>
